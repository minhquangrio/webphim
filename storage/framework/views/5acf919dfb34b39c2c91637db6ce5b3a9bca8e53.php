    ...
    <div class="row justify-content-center">
        <div class="col-md-14">
            <div class="card" >
                ...
                <a href="<?php echo e(route('country.create')); ?>" class="btn btn-primary">Thêm quốc gia</a>
                <div class="card-body" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo e(route('country.edit', $cate->id)); ?>" class="btn btn-warning d-inline-block">Sửa</a>
                        </td>
                    </tr>
