...
<div class="row container" id="wrapper">
            <div class="halim-panel-filter">
               <div class="panel-heading">
                  <div class="row">
                     <div class="col-xs-9">
                        <div class="yoast_breadcrumb hidden-xs"><span class="fa-regular fa-heart"></span><span>Bạn đang xem phim tại 4K CINEMA, chúc bạn có những phút giây vui vẻ!</span></div>
                     </div>
                  </div>
               </div>
            ...
            <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
               <section>
                  <div class="section-bar clearfix">
                     <h1 class="section-title"><span>Kết quả tìm kiếm cho: <?php echo e($search); ?></span></h1>
                  </div>
