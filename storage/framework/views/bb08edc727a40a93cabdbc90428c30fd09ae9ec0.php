...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <link rel='stylesheet' id='bootstrap-css' href='<?php echo e(asset('css/bootstrap.min.css?ver=5.7.2')); ?>' media='all' />
        <link rel='stylesheet' id='style-css' href='<?php echo e(asset('css/style.css?ver=5.7.2')); ?>' media='all' />
        <link rel='stylesheet' id='wp-block-library-css' href='<?php echo e(asset('css/style.min.css?ver=5.7.2')); ?>' media='all' />
        <script type='text/javascript' src='<?php echo e(asset('js/jquery.min.js?ver=5.7.2')); ?>' id='halim-jquery-js'></script>
        ...
        <style>
        #header .site-title
         {background: url("<?php echo e(asset('imgs/logo.png')); ?>") no-repeat top left;background-size: contain;text-indent: -9999px; margin-top: 5px;}
         </style>  
    </head>
    ...
    <body class="home blog halimthemes halimmovies" data-masonry="">
           ...
           <div class="container">
              <div class="row" id="headwrap">
                 ...
                 <div class="col-md-3 col-sm-6 slogan">
                    <p class="site-title"><a class="logo" href="<?php echo e(url('/')); ?>"></a></p>                                                       
                 </div>
                 ...
                 <div class="col-md-4 hidden-xs" style="margin-left: 780px; margin-top: -45px">    
                     ...
                     <?php if(Auth::check()): ?>
                       ...
                       <div class="dropdown" style="margin-right:180px; margin-top: 0px;">
                          ...
                          <div class="dropdown-menu" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?php echo e(route('setting_info')); ?>">Tài khoản</a><br>
                                <a class="dropdown-item" href="<?php echo e(route('log_out')); ?>">Đăng xuất</a>
                          </div>
                       </div>
                       
                       <a href="<?php echo e(route('show_bookmark')); ?>"><button class="btn btn-warning">Bookmark</button></a>
                     <?php else: ?>
                    ...
                    <span style="padding: 10px; margin-top: -20px"><a href="<?php echo e(route('package')); ?>">
                    ...
                    <div class="menu-menu_1-container">
                       <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                          <li class="current-menu-item active">
                             <a title="Trang Chủ" href="<?php echo e(route('homepage')); ?>">Trang Chủ</a>
                          </li>
                          <li class="mega dropdown">
                             <a title="Thể Loại" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Thể Loại<span class="caret"></span></a>
                             <ul role="menu" class=" dropdown-menu">
                                <?php $__currentLoopData = $genre; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                   <li><a title="<?php echo e($cate->title); ?>" href="<?php echo e(route('genre',$cate->slug)); ?>"><?php echo e($cate->title); ?></a></li>
                          ...
                          <li class="mega dropdown">
                             ...
                             <ul role="menu" class=" dropdown-menu">
                                <?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                   <li><a title="<?php echo e($cate->title); ?>" href="<?php echo e(route('country',$cate->slug)); ?>"><?php echo e($cate->title); ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                             </ul>
                          </li>
                          <li class="mega dropdown">
                             ...
                             <ul role="menu" class=" dropdown-menu">
                                <?php for($year=1980; $year<=2023; $year++): ?>
                                   <li><a title="<?php echo e($year); ?>" href="<?php echo e(url('nam/'.$year)); ?>"><?php echo e($year); ?></a></li>
                                <?php endfor; ?>
                             </ul>
                          </li>
        ...
        <footer class="text-center text-lg-start bg-light text-muted">
           ...
           <div>
              <a href="https://www.facebook.com/people/4K-Cinema/100094359952428/" class="me-4 text-reset">
           ...
           <div class="container text-center text-md-start mt-5">
              <div class="row mt-3">
                 ...
                 <p>
                    <a href="<?php echo e(route('package')); ?>" class="text-reset">Đăng ký gói VIP <i class="fas fa-heartbeat faa-pulse"></i>
                    </a>
                 </p>
                 <p>
                 ...
                 <p>
                    <a href="<?php echo e(URL::to('/danh-muc/phim-chieu-rap')); ?>" class="text-reset">Phim Chiếu Rạp Mới Nhất</a>
                 </p>
                 <p>
                    <a href="<?php echo e(URL::to('/danh-muc/phim-hanh-dong')); ?>" class="text-reset">Phim Hành Động Mới Nhất</a>
                 </p>
                 <p>
                    <a href="<?php echo e(URL::to('/danh-muc/phim-tinh-cam')); ?>" class="text-reset">Phim Tình Cảm Mới Nhất</a>
                 </p>
                 
                 <p>
                    <a href="<?php echo e(URL::to('/danh-muc/phim-kinh-di')); ?>" class="text-reset">Phim Kinh Dị Mới Nhất</a>
                 </p>
                 </div>
           ...
           © 2023 Copyright:
           <a class="text-reset fw-bold" href="<?php echo e(url('/')); ?>">4K CINEMA</a>
           </div>
        </footer>
        <!--END FOOTER -->
       ...
       <script type="text/javascript">
        $(document).ready(function(){
           ...
           $.ajax({
              url:"<?php echo e(url('/filter-topview-default')); ?>",
              method:"GET",
           ...
           $('.filter-sidebar').click(function(){
              ...
              $.ajax({
                 url:"<?php echo e(url('/filter-topview-phim')); ?>",
                 method:"POST",
                 data:{value:value},
                 headers: {
...
<?php /**PATH D:\SoureCode\Laravel\new_4kcinema\resources\views/layout.blade.php ENDPATH**/ ?>