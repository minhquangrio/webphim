...
<div class="row container" id="wrapper">
            <div class="halim-panel-filter">
               <div class="panel-heading">
                  <div class="row">
                     <div class="col-xs-6">
                        <div class="yoast_breadcrumb hidden-xs"><span><span><a href=""><?php echo e($country_slug->title); ?></a> » <span class="breadcrumb_last" aria-current="page"><?php echo e(date('Y')); ?></span></span></span></div>
                     </div>
                  </div>
               </div>
