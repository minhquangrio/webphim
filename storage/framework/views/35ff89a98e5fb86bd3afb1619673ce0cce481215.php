...
<div class="row container" id="wrapper">
            ...
            <div class="halim-panel-filter">
               <div class="panel-heading">
                  <div class="row">
                     <div class="col-xs-6">
                        <div class="yoast_breadcrumb hidden-xs"><span><span>Năm Phát Hành »
                        <?php for($year_bread=1980; $year_bread<=2023; $year_bread++): ?>   
                            <span class="breadcrumb_last" aria-current="page"><a title="<?php echo e($year_bread); ?>" href="<?php echo e(url('nam/'.$year_bread)); ?>"><?php echo e($year_bread); ?></a></span> » 
                        <?php endfor; ?> 
                        </span>
                    </span>
                </div>
            ...
            <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
               <section>
                  <div class="section-bar clearfix">
                     <h1 class="section-title"><span>Năm : <?php echo e($year); ?></span></h1>
                  </div>
